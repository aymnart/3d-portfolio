  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-0 bg-gradient-to-t from-foreground to-primary py-4 bg-clip-text text-center text-5xl font-medium tracking-tight text-transparent md:text-7xl">
...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        'relative flex min-h-screen flex-col items-center justify-center overflow-x-clip bg-background w-full rounded-md z-0',
        className,
      )}>
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-primary/80 blur-2xl"></motion.div>
        <motion.div
          initial={{ width: '15rem' }}
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-primary/80 "></motion.div>
